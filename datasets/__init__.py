...
def get_dataset(args, config):
    ...
    if config.data.dataset == "CIFAR10":
        ...
        dataset = CelebaHQ(root=os.path.join(args.exp, "datasets", "celebahq-lmdb"), name='celebahq',
        ...
        dataset = FFHQ64(root=os.path.join(args.exp, "datasets", "ffhq64"),
                              train=True, transform=train_transform)
        test_dataset = None
        ...
        dataset = AFHQ(root=os.path.join(args.exp, "datasets", "afhq"),
                              train=True, transform=train_transform)
        test_dataset = None
